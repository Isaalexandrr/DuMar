          ...
          <div className={styles.row}>
            <div className={styles.col}>
              ...
              <div className={styles.inputBox}>
                ...
                <input type="text"  placeholder="Seu Nome Completo" value={nome} onChange={(e)=>
              ...
              <div className={styles.inputBox}>
                <span>Email:</span>
                <input type="email" placeholder="Example@example.com"  value={email} onChange={(e)=>
              ...
              <div className={styles.inputBox}>
                <span>Endereço:</span>
                <input type="text" placeholder="Digite seu endereço completo" value={endereco} onChange={(e)=>
              ...
              <div className={styles.inputBox}>
                <span>Cidade:</span>
                 <input type="text" placeholder="Recife" value={cidade} onChange={(e)=>
              ...
              <div className={`${styles.flex} ${styles.addressFlex}`}>
                <div className={styles.inputBox}>
                  <span>Estado:</span>
                  <input type="text" placeholder="Pernambuco"  value={estado} onChange={(e)=>
                ...
                <div className={styles.inputBox}>
                  <span>CEP:</span>
                  <input type="text" placeholder="123 456 123 -88" value={cep} onChange={(e)=>
            ...
            <div className={styles.col}>
              ...
              <div className={styles.inputBox}>
                <span>Chave PIX:</span>
                <input type="text" placeholder="Exemplo: seuemail@provedor.com.br" value={pix} onChange={(e)=>
              ...
              <div className={styles.inputBox}>
                ...
                <input type="text"  placeholder="Nome impresso no cartão" value={nomecartao} onChange={(e)=>
              ...
              <div className={styles.inputBox}>
                ...
                <input type="number" placeholder="1111-2222-3333-4444" value={numerocartao} onChange={(e)=>
              ...
              <div className={styles.inputBox}>
                ...
                <input type="text" placeholder="Janeiro" value={mesexpiracao} onChange={(e)=>
                 
                 setMesExpiracao(e.target.value) 
                 }/>
              </div>
              <div className={`${styles.flex} ${styles.paymentFlex}`}>
                <div className={styles.inputBox}>
                  <span>Ano de expiração:</span>
                  <input type="number" placeholder={2022} value={anoexpiracao} onChange={(e)=>
                 
                 setAnoExpiracao(e.target.value) 
                 }/>
                </div>
                <div className={styles.inputBox}>
                  <span>CVV :</span>
                  <input type="text" placeholder={1234} value={cvv} onChange={(e)=>
