        ...
        <div className="col-12 col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 text-center mt-5"> 
          ...
          <form className="text-start mt-4">
            <div className="text-start mt-4">
              <label htmlFor="nome" className="fw-bold ms-2">
                Nome do Produto:
              </label>
              <input
                type="text"
            ...
            <div className="text-start w-75 mt-4 d-flex">
              <div className="d-block w-50">
                <label className="fw-bold ms-2" htmlFor="quantidade">
                  Quantidade:
                </label>
                <input
                  type="text"
              ...
              <div className="text-start w-50 ms-2 d-block">
                <label className="fw-bold ms-2" htmlFor="Medida">
                  Medida
                </label>
            ...
            <div className="d-block w-25 w-xs-50 w-sm-50 w-md-25 w-lg-25 w-xl-25 w-xxl-25 mt-4">
              <label className="fw-bold ms-2" htmlFor="dataPesc">
                Data de Pesca
              </label>
              <input
                type="date"
            ...
            <div className="text-start w-50 mt-4">
              <label htmlFor="valorDiv" className="fw-bold ms-2">
                Valor:
              </label>
